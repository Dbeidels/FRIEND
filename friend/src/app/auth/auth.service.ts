...
export class AuthService extends IonicAuth {
  ...
  private async addConfig() {
    ...
    const redirectUri = this.onDevice() ? 'com.okta.dev-675856:/callback' : window.location.origin + '/callback';
    const logoutRedirectUri = this.onDevice() ? 'com.okta.dev-675856:/logout' : window.location.origin + '/logout';
    const clientId = '0oare3n158aMgWNov4x6';
    const issuer = 'https://dev-675856.okta.com/oauth2/default';
